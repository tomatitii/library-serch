...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<sinatra>.freeze, ["~> 1.4.0".freeze])
  s.add_runtime_dependency(%q<backports>.freeze, [">= 2.0".freeze])
  s.add_runtime_dependency(%q<tilt>.freeze, [">= 1.3".freeze, "< 3".freeze])
  ...
  s.add_development_dependency(%q<rspec>.freeze, ["~> 2.3".freeze])
